...
tf.uiConfig = {
	...
	gauge : {
		...
		width          : 48,
		height         : 52,
		posx           : [1096, 340, 412, 484, 556, 628, 700, 772, 844, 916, 988],
		posy           : [190, 270, 350, 430]
	},
	...
	screen : {
		img_window     : tf.img_path + 'window_act.png',
		img_window_hov : tf.img_path + 'window_hov.png',
		img_full       : tf.img_path + 'full_act.png',
		img_full_hov   : tf.img_path + 'full_hov.png',
		width          : 120,
		height         :  50,
		pos_window     : [772, 510],
		pos_full       : [916, 510]
...
; btn back
;-----------------------------------------------------------------------------------------------------------------------
[button fix="true" graphic="&tf.img_path + 'btn_back.png'" enterimg="&tf.img_path + 'btn_back_hov.png'" target="*backtitle" x="1192" y="24"]
...
[if exp="tf.screen_size == 'full'"]
	...
	[image layer="0" name="screen_window" storage="&tf.uiConfig.screen.img_window" x="&tf.uiConfig.screen.pos_window[0]" y="&tf.uiConfig.screen.pos_window[1]"]
...
[if exp="tf.screen_size == 'window'"]
	...
	[image layer="0" name="screen_full" storage="&tf.uiConfig.screen.img_full" x="&tf.uiConfig.screen.pos_full[0]" y="&tf.uiConfig.screen.pos_full[1]"]
