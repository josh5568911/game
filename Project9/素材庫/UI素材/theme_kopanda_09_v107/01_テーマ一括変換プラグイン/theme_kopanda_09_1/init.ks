...
[position layer="message0" frame="../others/plugin/theme_kopanda_09_1/image/frame_message.png" margint="120" marginl="140" marginr="150" opacity="&mp.frame_opacity" page="fore"]
...
[if exp="mp.glyph == 'on'"]
[glyph line="../../../data/others/plugin/theme_kopanda_09_1/image/system/nextpage.png"]
[endif]
...
[iscript]
	...
	tf.sysbtn_img_path   = '../others/plugin/theme_kopanda_09_1/image/button/'; // 画像のパス
...
; コンフィグボタン
[button name="role_button" role="sleepgame" graphic="&tf.sysbtn_img_path + 'sleep.png'" enterimg="&tf.sysbtn_img_path + 'sleep2.png'" storage="../others/plugin/theme_kopanda_09_1/config.ks" x="&tf.sysbtn_posx[8]" y="&tf.sysbtn_posy"]
